# 🚀 Guia Rápido de Uso - Sistema Avançado Lotofácil
...
Você precisa do arquivo `treino.xlsx` com os sorteios históricos.

**Formato do Excel:**
- Cada linha = um sorteio
- 15 colunas com números de 1 a 25
- Exemplo:
```
num_1  num_2  num_3  ...  num_15
  1      3      5    ...    25
  2      4      7    ...    24
```
...
1. Clique em **"🎲 Gerar 15 Números Mais Prováveis"**
2. Aguarde o processamento (pode levar 1-2 minutos)
3. Veja os resultados:
   - **Previsão Principal**: Os 15 números recomendados
...
### Previsão Principal
Os **15 números mais prováveis** baseados em:
...
### Probabilidades
- **> 0.06**: Número muito provável
- **0.04 - 0.06**: Número provável
- **< 0.04**: Número menos provável
...
4. ✅ Verifique números com ausência prolongada
...
Edite `treino_avancado.py`, função `gerar_15_numeros_inteligentes`:
```python
...
- Verifique se `treino.xlsx` está na pasta `Lotofacil/`
