...
# ================================
# 🎲 Função para gerar previsões probabilísticas (original)
# ================================
...
# ================================
# 🎲 Nova função para gerar previsões com misto (11 mais + 4 menos)
# ================================
def gerar_previsoes_misto(modelo, n_previsoes=6, n_numeros=15, n_mais=11, n_menos=4):
    previsoes = []
    ...
    for _ in range(n_previsoes):
        ...
        top_numeros = mais_provaveis[:n_mais]
...
# Gerar previsões originais (10 sequências)
previsoes_originais, probs = gerar_previsoes_probabilisticas(modelo_final, n_previsoes=10, n_numeros=15)

# Gerar previsões com misto (6 sequências: 11 mais + 4 menos)
previsoes_misto = gerar_previsoes_misto(modelo_final, n_previsoes=6, n_numeros=15, n_mais=11, n_menos=4)
...
# Previsões originais
st.subheader("🎯 10 Previsões Probabilísticas Originais (15 números cada)")
for i, prev in enumerate(previsoes_originais, start=1):
    st.write(f"**Previsão {i}:** {prev}")

# Previsões com misto (11 mais prováveis + 4 menos prováveis)
st.subheader("🎯 6 Previsões Mistas (15 números: 11 mais prováveis + 4 menos prováveis)")
