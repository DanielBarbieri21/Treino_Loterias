"""
📡 Buscador de Dados da Lotofácil via API
==========================================
Permite buscar dados atualizados da Lotofácil via API pública da Caixa
"""
...
def buscar_dados_lotofacil_api(ultimos_n=None):
    """
    Busca dados da Lotofácil via API da Caixa
    ...
    """
    try:
        # API pública da Caixa (pode variar, verifique a documentação oficial)
        # Esta é uma API não oficial, mas funcional
...
def atualizar_excel_com_api(arquivo_excel="treino.xlsx", ultimos_n=100):
    """
    ...
    df_api = buscar_dados_lotofacil_api(ultimos_n=ultimos_n)
