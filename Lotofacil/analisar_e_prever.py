...
st.set_page_config(page_title="Lotofácil Profissional", layout="wide")
st.title("Lotofácil | Motor Profissional de Ranking")
st.caption("Avalia estratégias em janela temporal, escolhe a melhor no backtest e só então gera os jogos.")
